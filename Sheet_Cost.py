...
paper_weight = [140, 100, 0] # in g/m^2 [Bottom, Flute, Top]
paper_quality = [PaperQuality_Adjusted.Kraft, PaperQuality_Adjusted.Kraft, PaperQuality_Adjusted.PrePrinted] #[Bottom, Flute, Top]
